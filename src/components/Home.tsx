...
export default function Home({ onNavigate }: Props) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      // Load inbox children for GTD folders
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-px bg-border">
          {gtdFolders.map(f => (
            <div key={f.displayName} className="bg-surface px-4 py-2 flex items-center justify-between">
              <span className="text-text text-xs">{f.displayName}</span>
